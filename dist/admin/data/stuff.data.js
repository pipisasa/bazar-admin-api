...
const stuff_type_1 = __importDefault(require("../services/stuff/stuff.type"));
const loadStuffs = () => {
    return class_transformer_1.plainToClass(stuff_type_1.default, [
        {
            id: '1',
            first_name: 'James',
            last_name: 'Frank',
...
exports.default = loadStuffs;
//# sourceMappingURL=stuff.data.js.map